...
ComObjet::ComObjet(const char* id, const char* equipId) : Objet(id){
	this->serial = 0;
	this->equipId = crc32(equipId);
	this->serialReady = false;
	this->messageReady = false;
	this->changePinEvent = new ComObjetPinChangeEvent(this);
...
ComObjet::ComObjet(const char* id, const char* equipId, byte rxPin, byte txPin) : Objet(id){
	this->serial = 0;
	this->equipId = crc32(equipId);
	this->serialReady = false;
	this->messageReady = false;
