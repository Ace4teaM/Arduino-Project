...
static const unsigned int MessageTypeCommande = crc32("CMD");
static const unsigned int MessageTypeConfiguration = crc32("CFG");
static const unsigned int MessageTypeEtat = crc32("ETA");
