...
// Constructeur
BuiltHelloCmd::BuiltHelloCmd() : Commande("Hello"){
}

// Vérifie si la commande est executable
int BuiltHelloCmd::Executable(Objet* objet){
	return 1;
}

// Execute la commande
int BuiltHelloCmd::Executer(Objet* objet){
	Serial.println("Hello To");
	return 1;
}
